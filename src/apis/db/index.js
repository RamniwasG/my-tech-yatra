...
export const myProjects = [
    { 
        id: 0, type: 'web', title: 'Envista Phase2 Implementations', company: 'Credera', client: 'Envista', tenure: 'Jan-2025 to Till now',
        role: 'Senior Developer',
        desc: 'Envista is a part of the Envista familiy of dental operating companies, including more than 30 trusted brands and 125 years of dental experience. This application is used to create a common stack to provide seamless and rich feature user interface across all the brands and also seperates by static sites vs ecommerce sites as well. ecommerce sites provides all the ecom feature like displaying products, adding to cart and placing order based on location through different payment methods.',
        technologies: ['HTML', 'CSS', 'SiteStudio', 'DDEV', 'Docker'],
        isOpen: false
    },
    { 
        id: 1, type: 'web', title: 'WG Phase 3 Rollout for 8 sites', company: 'Credera', client: 'Envista', tenure: 'Jan-2024 to Dec 2024',
        role: 'Senior Developer',
    ...
    { 
        id: 2, type: 'web', title: 'Humana Staffing 2023', company: 'Credera', client: 'Humana', tenure: 'Feb-2023 to Oct-2023',
    ...
    { 
        id: 3, type: 'web', title: 'Platform Development of Micropore Tool', company: 'Innominds Pvt Ltd', client: 'AVG', tenure: 'Oct-2021 to Dec-2022',
        role: 'UI Engineer',
    ...
    { 
        id: 4, type: 'web', title: 'ECAT', company: 'Innominds Pvt Ltd', client: 'Ecat', tenure: 'Feb-2021 to Aug-2021',
        role: 'UI Engineer',
    ...
    { 
        id: 5, type: 'web', title: 'POS', company: 'Qvantel Solutions Pvt Ltd', client: 'Qvantel', tenure: '2019 - 2020',
        role: 'UI Developer',
    ...
    { 
        id: 6, type: 'web', title: 'InAppBi', company: 'Quanteon Solutions LLP', client: 'Quanteon Solutions LLP', tenure: '2018 - 2019',
        role: 'UI Developer',
    ...
    { 
        id: 7, type: 'mobile', title: 'ePropertyPlus', company: 'Quanteon Solutions LLP', client: 'Quanteon Solutions LLP', tenure: 'Mar-2018 to Jul-2018',
    ...
    { 
        id: 8, type: 'mobile', title: 'NextUp', company: 'Quanteon Solutions LLP', client: 'Quanteon Solutions LLP', tenure: '2017 - 2018',
        role: 'JavaScript Full Stack Developer',
    ...
    { 
        id: 9, type: 'web', title: 'Internal Project', company: 'Quanteon Solutions LLP', client: 'Quanteon Solutions LLP', tenure: '2016 - 2017',
